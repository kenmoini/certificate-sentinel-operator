...
spec:
  ...
  alerts: # alerts is a list of alerting endpoints associated with these below targets
  ...
  targets: # targets is a list of Kubernetes objects being targeted and scanned for x509 Certificate data
...
status: # .status is not user-defined, it will be updated at the end of a full scan/operator reconciliation and will list any certificates found, the ones expiring within our designated daysOut thresholds, and when the last reports were sent for each alert
  ...
  discoveredCertificates:
    - triggeredDaysOut:
      ...
      apiVersion: v1
  lastReportsSent:
    - alertName: secrets-logger
      lastSent: '2021-09-04 01:31:34.090014977 +0000 UTC'
    - alertName: secrets-mailer
      lastSent: '2021-09-04 01:26:24.270624493 +0000 UTC'
```